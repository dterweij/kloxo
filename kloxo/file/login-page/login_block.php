	...
	<div id="ctr" align="center">
		<div class="login">
			...
			<div class="login-text">
				...
				<br/>
				<a class="forgotpwd loginlinks" href="javascript:document.forgotpassword.submit()">
				...
				<script type="text/javascript"> document.loginform.frm_clientname.focus(); </script>
			</div>
			<div class="clr"></div>
		</div>
	</div>
...
<div id="ctr" align="center">
	<div class="login">
		...
		<div class="login-text">
			...
			<br/>
			<a class="forgotpwd loginlinks" href="javascript:history.go(-1);">
				<?php print(_('Back to Login')); ?>
			</a>
		...
		<script type="text/javascript"> document.sendmail.frm_clientname.focus(); </script>
...
// ToDo: Make a valid email with headers and charset encoding
