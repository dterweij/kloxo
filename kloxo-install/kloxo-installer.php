...
function lxins_main()
{
	...
	$packages = array("php-mbstring", "php-mysql", "which", "gcc-c++", "php-imap", "php-pear", "php-devel",
						"kloxo-core-lighttpd", "httpd", "mod_ssl", "zip", "unzip", "kloxo-core-php", "mariadb",
						"mariadb-server", "curl", "autoconf", "automake", "libtool", "bogofilter", "gcc", "cpp",
						"openssl", "pure-ftpd", "yum-protectbase");
